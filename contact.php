...
<div class="container">
  <div class="row">
    <div class="col-lg-8 col-md-8 col-10  offset-lg-2  offset-md-2 offset-1">
          ...
          <input type="text" class="form-control" id="userfirst" placeholder="First Name"  required autocomplete="off" name="first">
        </div>

          <div class=" form-group  col-12">
         
          <input type="text" class="form-control" id="userlast" placeholder="Last Name" required autocomplete="off" name="last">
        </div>
